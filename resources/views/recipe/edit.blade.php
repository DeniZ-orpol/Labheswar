                ...
                <tbody class="quote-item-container table-body">
                    @foreach ($ingredientsWithProduct as $index => $ingredient)
                        <tr class="border-b text-gray-700 uppercase text-sm quote-item-row" data-index="{{ $index }}">
                            ...
                            <th scope="col" class="required">
                                <input type="number" name="ingredient_quantity[]" id="ingredient_quantity_{{ $index }}" class="form-control qty" required min="0"
...
document.addEventListener('DOMContentLoaded', function() {
    var rowIndex = {{ count($ingredientsWithProduct) - 1 }};
