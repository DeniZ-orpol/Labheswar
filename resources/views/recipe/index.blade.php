...
@section('content')
    @php
        $isPaginated = method_exists($recipes, 'links');
    @endphp
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 grid-updated">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ Route('recipe.create') }}" class="btn btn-primary shadow-md mr-2 btn-hover">Add Formula</a>
            </div>
            ...
            <div class="intro-y col-span-12 overflow-auto">
                    ...
                    <tbody>
                        @forelse($recipes as $index => $recipe)
                            <tr class="border-b">
                                ...
                                <td class="px-4 py-2">{{ $recipe->product->product_name }}</td>
                                <td>
                        ...
                        @empty
                            <tr >
                                <td colspan="4" class="text-center text-gray-500 py-4">No Recipes found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                @if ($isPaginated && $recipes->count() > 0)
                        ...
                        <div class="pagination-nav">
                            <nav role="navigation" aria-label="Pagination Navigation">
                                <ul class="pagination">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $recipes->previousPageUrl() }}"
                                                rel="prev">‹</a>
                                        </li>
                                    @endif
                                    ...
                                    @if ($recipes->hasMorePages())
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $recipes->nextPageUrl() }}"
                                                rel="next">›</a>
                                        </li>
                                    @else
                                        <li class="page-item disabled" aria-disabled="true">
