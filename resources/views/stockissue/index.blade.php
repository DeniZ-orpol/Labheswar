...
@section('content')
    @php
        $isPaginated = method_exists($stockIssues, 'links');
    @endphp
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 grid-updated">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ Route('stockissue.create') }}" class="btn btn-primary shadow-md mr-2 btn-hover">Add Stock
                    Issue</a>
            </div>
                ...
                <div id="scrollable-table"
                    ...
                    <table id="DataTable" class="display table table-bordered w-full">
                        <thead style="position: sticky; top: 0; z-index: 10;">
                          ...
                          <tbody id="TableBody">
                            @include('stockissue.rows', ['page' => 1])
                        </tbody>
                    </table>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        function loadMoreData(page) {
            fetch(`{{ route('stockissue.index') }}?page=${page}`)
