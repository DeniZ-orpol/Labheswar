        ...
        <div class="row">
            ...
            <div class="column">
                <div class="input-form col-span-3 mt-3 form-check form-switch w-full sm:ml-auto">
                    ...
                    <input id="auto_production" type="checkbox" name="auto_production" class="form-check-input mr-0 ml-3">
                </div>
            </div>
        </div>
            ...
            <table class="w-full mb-4 bg-transparent table-striped mt-4" id="billTbl">
                ...
                <tbody class="quote-item-container table-body" id="product-table-body">
                    <tr class="border-b text-gray-700 uppercase text-sm quote-item-row" data-index="0">
                        ...
                        <td scope="col" class="required">
                            <input type="text" name="ingredient_quantity[]" id="ingredient_quantity_0" class="form-control qty" required >
                        </td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        //         </th>
        //         <th scope="col" class="required">
        //             <input type="number" name="ingredient_quantity[]" id="ingredient_quantity_${rowIndex}" class="form-control qty" required min="0">
        //         </th>
