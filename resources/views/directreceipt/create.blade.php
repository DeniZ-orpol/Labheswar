...
<div class="content">
    ...
    <form action="{{ route('directreceipt.store') }}" method="POST">
        @csrf
            ...
            <table class="w-full mb-4 bg-transparent table-striped mt-4" id="billTbl">
                ...
                <tbody class="quote-item-container table-body" id="product-table-body">
                    <tr class="border-b text-gray-700 uppercase text-sm quote-item-row" data-index="0">
                        ...
                        <th>
                            <input type="number" name="cost[]" class="form-control field-new cost" maxlength="255" readonly step="0.001">
                        ...
                        <th>
                            <input type="number" name="sale_rate[]" onchange="calculateRowAmount(this)" class="form-control field-new sale_rate" maxlength="255" step="0.001">
                        </th>
                        <th>
