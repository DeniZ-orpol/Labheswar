...
@section('content')
    <div class="content">
        ...
        @if (session('error'))
            <div id="error-alert" class="alert alert-danger" style=" background-color: #f8d7da; color: #721c24;border: 1px solid #f5c6cb; padding: 10px; border-radius: 5px; margin-bottom: 10px;">
                {{ session('error') }}
            </div>
            ...
            <div class="grid grid-cols-12 gap-2 grid-updated">
                ...
                <div class="input-form col-span-8">
                    ...
                    <div class="product-search-container" style="position: relative;">
                        ...
                        <input type="hidden" id="product_id" name="raw_product_id" class="product_id" required>
                        <input type="hidden" name="raw_quantity" id="hidden_raw_quantity">
                        <input type="hidden" id="raw_product_quantity" value="0">
                        <input type="hidden" id="raw_product_unit">
                ...
                <table class="w-full mb-4 bg-transparent table-striped mt-4" id="billTbl">
                    ...
                    <tbody class="quote-item-container product-table-body" id="product-table-body">
                        <tr class="border-b text-gray-700 uppercase text-sm quote-item-row" data-index="0">
                            ...
                            <th scope="col" class="required">
                                <input type="number" name="add_quantity[]" id="add_quantity" class="form-control qty"
                                    required min="0">
                            </th>
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12">
                        ...
                        <input id="modal-raw-qty" name="raw_quantity" type="number" class="form-control"
                            placeholder="Enter Quantity of raw product" required>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const mainForm = document.querySelector('form[action="{{ route('one-to-many.store') }}"]');
