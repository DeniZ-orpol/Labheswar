...
@section('subhead')
    <title>Create user - Midone - Tailwind Admin Dashboard Template</title>
@endsection
...
@section('subcontent')
    <div class="mt-8 flex items-center">
        ...
        {{-- @if ($errors->any())
            <div class="alert alert-danger p-4 mb-4 rounded bg-red-100 text-red-700">
                    ...
                    <div class="p-5">
                        <div class="grid grid-cols-12 gap-x-5">
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <x-base.form.item class="mt-3">
                                    <x-base.label for="user-phone-number">
                                        Phone Number
                                    </x-base.label>
                                    <x-base.input
                                        class="{{ $errors->has('mobile') ? 'border-red-500' : '' }}"
                            ...
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <x-base.form.item class="mt-3">
                                    ...
                                    <x-base.input
                                        class="{{ $errors->has('confirm_password') ? 'border-red-500' : '' }}"
