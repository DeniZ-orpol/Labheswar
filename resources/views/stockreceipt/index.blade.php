...
@section('content')
    @php
        $isPaginated = method_exists($stockReceipts, 'links');
    @endphp
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 grid-updated">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ Route('stockreceipt.create') }}" class="btn btn-primary shadow-md mr-2 btn-hover">Add Stock Receipt</a>
            </div>
            ...
            <div class="intro-y col-span-12 overflow-auto">
                <div id="scrollable-table"
                    ...
                    <tbody id="TableBody">
                        @include('stockreceipt.rows', ['page' => 1])
                    </tbody>
                </table>
...
<script>
        ...
        function fetchMoreData(page) {
            const url = new URL('{{ route('stockreceipt.index') }}');
