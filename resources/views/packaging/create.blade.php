        ...
        <div class="row">
            <div class="column">
                <div class="mb-3">
                    ...
                    <input type="text" name="group" id="group" class="form-control group" required>
                </div>
            </div>
        </div>
                    ...
                    <tr class="border-b text-gray-700 uppercase text-sm quote-item-row" data-index="0">
                        <td scope="col" class="required">
                            <div class="product-search-container" style="position: relative;">
                                <input id="product_search_0" type="text" name="product_search[]" class="form-control field-new product_search product-search-input"
                                    placeholder="Type to search products..." autocomplete="off" required>
                                <input type="hidden" id="product_id_0" name="product_id[]" class="product_id" required>
                        ...
                        <td scope="col" class="required">
                            <input type="text" name="weight_from[]" id="weight_from_0" class="form-control weight_from" required >
                        </td>
                        <td scope="col" class="required">
                            <input type="text" name="weight_to[]" id="weight_to_0" class="form-control weight_to" required >
                        </td>
