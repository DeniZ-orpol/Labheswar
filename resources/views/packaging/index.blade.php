...
@section('content')
    @php
        $isPaginated = method_exists($packagings, 'links');
    @endphp
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 grid-updated">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ Route('packaging.create') }}" class="btn btn-primary shadow-md mr-2 btn-hover">Add Group</a>
            </div>
...
@push('scripts')
    <script>
        ...
        function fetchMoreData(page) {
            const url = new URL('{{ route('packaging.index') }}');
