            ...
            <div class="">
                ...
                <div class="mt-5 grid grid-cols-2 gap-x-6 gap-y-4">
                    <a
                        ...
                        href="{{ route('layout-switcher', ['activeLayout' => 'side-menu']) }}"
                    >
                        <div @class([
                            'dark:bg-foreground/20 h-24 overflow-hidden rounded-lg shadow-md image-fit ring-1 ring-offset-4 ring-offset-background shadow-lg p-px',
                    ...
                    <a
                        class="flex flex-col gap-3 transition-transform duration-100 hover:scale-[105%]"
                        href="{{ route('layout-switcher', ['activeLayout' => 'top-menu']) }}"
                    >
                        <div @class([
                            'dark:bg-foreground/20 h-24 overflow-hidden rounded-lg shadow-md image-fit ring-1 ring-offset-4 ring-offset-background shadow-lg p-px',
